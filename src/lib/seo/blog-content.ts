...
export const blogArticles: Record<string, BlogArticle> = {
  ...
  "ui-post-utme-cut-off-mark": {
    ...
    faq: [
      { question: "What is the JAMB cut-off mark for UI?", answer: "The University of Ibadan sets a general JAMB UTME cut-off of 200 for ALL courses. Scoring 200 qualifies you to register for the Post-UTME screening — it does not guarantee admission. Your admission depends on your aggregate score meeting your department's specific cut-off. Read our [complete cut-off marks guide](/blog/ui-post-utme-cut-off-mark) or [practice past questions](/signup) to boost your scores." },
      { question: "How is the UI aggregate score calculated?", answer: "UI calculates your aggregate as: (JAMB Score ÷ 8) + (Post-UTME Score ÷ 2). For example, JAMB 320 and Post-UTME 70: (320/8) + (70/2) = 40 + 35 = 75. O'Level results are NOT part of this calculation — they are only a prerequisite (minimum 5 credits). Try our [UI Post-UTME score calculator](/blog/ui-post-utme-score-calculator) to easily calculate your aggregate." },
    ],
    sections: [
  ...
  "ui-post-utme-exam-format": {
    ...
    faq: [
      { question: "How many questions are in UI Post-UTME?", answer: "The UI Post-UTME typically has 100 multiple-choice questions: 25 per subject across English, Chemistry, Physics, and Biology (or your relevant subject combination). Practice all subjects in a timed simulator on [StudyBond](/signup)." },
      { question: "How long is the UI Post-UTME?", answer: "You have 90 minutes (1 hour 30 minutes) to complete all 100 questions. That's approximately 54 seconds per question. Practice under identical conditions with [StudyBond's timed exams](/signup)." },
      { question: "Is the UI Post-UTME a computer-based test?", answer: "Yes, the University of Ibadan Post-UTME is a Computer-Based Test (CBT). You answer questions on a computer screen. [Practice with StudyBond's CBT simulation](/signup) to get comfortable with the format." },
    ],
    sections: [
  ...
  "ui-post-utme-score-calculator": {
    ...
    faq: [
      { question: "How is the UI aggregate score calculated?", answer: "The formula is: Aggregate = (JAMB Score ÷ 8) + (Post-UTME Score ÷ 2). O'Level results are NOT included in the aggregate — they are only a prerequisite (minimum 5 credits). Maximum possible aggregate is 100. Use our online [UI aggregate score calculator](/blog/ui-post-utme-score-calculator) for easy calculation." },
      { question: "What aggregate score do I need for UI?", answer: "It depends on your course. In 2025: Medicine required 78.875, Law 70.875, Mechanical Engineering 70.5, Computer Science 63.5, Economics 58.125. Many courses in Agriculture and Education have cut-offs around 50. Check our [complete department cut-off marks guide](/blog/ui-post-utme-cut-off-mark) for details." },
    ],
    sections: [
  ...
  "best-ui-post-utme-practice": {
    ...
    faq: [
      { question: "What is the best site to practice UI Post-UTME?", answer: "StudyBond is the best platform for UI Post-UTME practice. It offers real, verified past questions in timed CBT simulation (100 questions, 90 minutes), score analytics by subject, leaderboards, daily streaks, and 1v1 duels. The first exam is completely free. [Start practicing on StudyBond for free](/signup) today." },
      { question: "Can I practice UI Post-UTME online for free?", answer: "Yes. StudyBond offers your first full UI Post-UTME exam completely free — no credit card required. This includes 100 real past questions, timed CBT, and a score breakdown. [Create your free account](/signup) to get started." },
    ],
    sections: [
  ...
  "ui-post-utme-registration": {
    ...
    title: "UI Post-UTME Registration Guide 2026 — Form, Dates & Process",
    metaTitle: "UI Post-UTME Form 2026 Out — Registration Dates & Deadline",
    metaDescription: "The University of Ibadan (UI) Post-UTME 2026/2027 screening form is officially out! Registration runs June 22 to July 19, 2026. Get official dates, requirements, fee, and step-by-step registration instructions.",
    datePublished: "2025-06-01",
    dateModified: "2026-06-15",
    keywords: [
      "UI post utme registration 2026",
      "UI post utme form 2026",
      "how to register for UI post utme 2026",
      "university of ibadan post utme form 2026",
    ...
    faq: [
      { question: "Is the UI Post-UTME 2026 registration form out?", answer: "Yes! The University of Ibadan (UI) has officially released the registration form for the 2026/2027 academic session. The admissions portal opens on Monday, June 22, 2026, and closes on Sunday, July 19, 2026." },
      { question: "When is the UI Post-UTME 2026 exam date?", answer: "The computer-based (CBT) screening exam will take place from Monday, July 27, 2026, to Wednesday, July 29, 2026. Start preparing immediately by practicing real past questions on the [StudyBond CBT simulator](/signup)." },
      { question: "What is the UI Post-UTME 2026 registration fee?", answer: "The registration fee is paid online through the official admissions portal (admissions.ui.edu.ng). Candidates should log in to generate their specific transaction invoice and make payments online when registration opens. Learn more in our [complete UI registration guide](/blog/ui-post-utme-registration)." },
    ],
    sections: [
      { heading: "Official UI Post-UTME 2026 Timeline", content: "The University of Ibadan has officially announced the registration schedule for the 2026/2027 admission screening exercise. Here are the key dates candidates must note:\n\n- **Registration Portal Opens**: Monday, 22 June 2026\n- **Registration Portal Closes**: Sunday, 19 July 2026\n- **Post-UTME CBT Examination**: Monday, 27 July 2026 to Wednesday, 29 July, 2026\n\n**Warning**: UI Registrar G. O. Saliu signed the official notice stating there will be NO extension of the registration period. Complete your registration early on the official portal **admissions.ui.edu.ng**." },
      { heading: "Eligibility Requirements for UI 2026 Screening", content: "To register for the UI 2026 Post-UTME, you must meet the following eligibility criteria:\n\n1. **First Choice**: Must have chosen the University of Ibadan as your first choice institution in the 2026 UTME.\n2. **JAMB Score**: Scored at least 200 in the 2026 JAMB UTME. UI uses a uniform cut-off of 200 for all courses, though competitive courses will require much higher aggregates for final admission.\n3. **O'Level Requirements**: Minimum of 5 O'Level credit passes in relevant subjects (including English and Mathematics) in not more than two sittings (one sitting for Medicine/Pharmacy).\n4. **Age**: Be at least 16 years of age by September 30, 2026." },
      { heading: "Step-by-Step UI Post-UTME 2026 Registration Guide", content: "Follow these steps to complete your registration on the official portal:\n\n1. Visit the official UI admissions portal: **admissions.ui.edu.ng**.\n2. Log in using your **JAMB Registration Number** as username and your **Surname in CAPITALS** as password.\n3. Complete the bio-data form and upload your O'Level results.\n4. Generate the transaction invoice and pay the required fee online using Remita (card or bank transfer).\n5. Print your payment invoice and print the **Post-UTME Screening Photocard**. This photocard contains your specific exam date, time, and seat number.\n6. Return to the portal regularly for exam notifications and schedules." },
      { heading: "How to Prepare and Pass the UI 2026 CBT Exam", content: "The UI Post-UTME is a 90-minute CBT exam with 100 questions (25 questions per subject). With the exam scheduled for July 27-29, 2026, candidates have just a few weeks to prepare. The most effective strategy is practicing with real, verified UI Post-UTME past questions under timed conditions.\n\n[StudyBond's timed CBT simulator](/signup) reproduces the exact exam environment with 1000+ real past questions. Start practicing daily, analyze your weak subjects, and build consistency to secure your admission." },
    ],
  },
  "ui-mbbs-post-utme": {
    ...
    faq: [
      { question: "What is the JAMB cut-off for UI Medicine?", answer: "The JAMB cut-off for UI is 200 for ALL courses, including Medicine. There is no higher per-course JAMB requirement. However, because Medicine has the highest aggregate cut-off (78.875 in 2025), you need a strong JAMB score to have a realistic chance — typically 300+ to leave room for a manageable Post-UTME target. See the full list of [UI cut-off marks by department](/blog/ui-post-utme-cut-off-mark) for details." },
      { question: "What subjects do I need for UI MBBS Post-UTME?", answer: "You need English Language, Chemistry, Physics, and Biology — the same 4 subjects you wrote in JAMB. All four are tested with 25 questions each in the Post-UTME. Practice Medicine subject combinations on [StudyBond](/signup)." },
    ],
    sections: [
  ...
  "ui-engineering-post-utme": {
    ...
    faq: [
      { question: "What JAMB score do I need for UI Engineering?", answer: "The JAMB cut-off for UI is 200 for ALL courses, including Engineering. There is no higher per-course JAMB requirement. However, Mechanical Engineering's 2025 aggregate cut-off was 70.5, so you need a strong JAMB score (280+) to have a realistic chance. See the full list of [UI cut-off marks](/blog/ui-post-utme-cut-off-mark) to check your target score." },
      { question: "What subjects are tested for UI Engineering Post-UTME?", answer: "Engineering candidates are tested on the same 4 subjects they wrote in JAMB — typically English, Mathematics, Physics, and Chemistry. 25 questions per subject. Practice engineering past questions in a timed CBT simulation on [StudyBond](/signup)." },
    ],
    sections: [
