...
export const blogArticles: Record<string, BlogArticle> = {
  ...
  "ui-post-utme-registration": {
    ...
    faq: [
      ...
      { question: "What is the UI Post-UTME 2026 registration fee?", answer: "The official registration screening fee is ₦2,000 (excluding bank charge/portal fee). Payments are made online through the official admissions portal (admissions.ui.edu.ng) when registration opens. Learn more in our [complete UI registration guide](/blog/ui-post-utme-registration)." },
    ],
    sections: [
