...
export const blogArticles: Record<string, BlogArticle> = {
  ...
  "ui-post-utme-registration": {
    ...
    faq: [
      { question: "When does UI Post-UTME registration open?", answer: "Registration typically opens between July and August each year. For the 2025/2026 session, it ran from July 21 to August 17, 2025. Monitor the official UI admissions portal (admissions.ui.edu.ng) for updates. While you wait, [start practicing real past questions on StudyBond](/signup) to build your confidence." },
      { question: "What is the UI Post-UTME registration fee?", answer: "For the 2025/2026 session, candidates paid ₦3,000 (portal access fee) + ₦2,000 (screening fee) = ₦5,000 total. Payment is made online through the official admissions portal. Learn more in our [complete UI registration guide](/blog/ui-post-utme-registration)." },
    ],
    sections: [
